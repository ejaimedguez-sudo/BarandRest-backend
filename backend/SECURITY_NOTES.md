...
Si deseas, puedo:
- Reubicar el script en `scripts/` con lectura de variable de entorno en vez de clave embebida.
- Añadir entradas a `.gitignore` para evitar subir archivos de claves accidentalmente.
